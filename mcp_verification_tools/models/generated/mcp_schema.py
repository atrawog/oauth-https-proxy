...
#   filename:  mcp-2025-06-18.json
#   timestamp: 2025-08-28T21:28:43+00:00
                ...
                "definitions": {
                    ...
                    "ListPromptsResult": {
                        ...
                        "properties": {
                            ...
                            "prompts": {"items": {"$ref": "#/definitions/Prompt"}, "type": "array"},
                        },
                        "required": ["prompts"],
                        "type": "object",
                    },
...
class BlobResourceContents(BaseModel):
    field_meta: Annotated[Optional[Dict[str, Any]], Field(alias="_meta")]
    """
...
class ClientCapabilities(BaseModel):
    ...
    """
    experimental: Optional[Dict[str, Dict[str, Any]]]
    """
...
class ElicitResult(BaseModel):
    ...
    - "cancel": User dismissed without making an explicit choice
    """
    content: Optional[Dict[str, Union[str, int, bool]]]
    """
...
class ModelPreferences(BaseModel):
    ...
    costPriority: Annotated[Optional[float], Field(ge=0.0, le=1.0)]
    """
    ...
    MAY still use the priorities to select from ambiguous matches.
    """
    intelligencePriority: Annotated[Optional[float], Field(ge=0.0, le=1.0)]
    """
    How much to prioritize intelligence and capabilities when selecting a
    model. A value of 0 means intelligence is not important, while a value of 1
    means intelligence is the most important factor.
    """
    speedPriority: Annotated[Optional[float], Field(ge=0.0, le=1.0)]
    """
...
class ProgressToken(RootModel[Union[str, int]]):
    root: Union[str, int]
    """
...
class FieldMeta(BaseModel):
    ...
    progressToken: Optional[Union[str, int]]
    """
    If specified, the caller is requesting out-of-band progress notifications for this request (as represented by notifications/progress). The value of this parameter is an opaque token that will be attached to any subsequent notifications. The receiver is not obligated to provide these notifications.
    """


class Params22(BaseModel):
    field_meta: Annotated[Optional[FieldMeta], Field(alias="_meta")]
    """
    See [General fields: `_meta`](/specification/2025-06-18/basic/index#meta) for notes on `_meta` usage.
    """
...
class ServerCapabilities(BaseModel):
    ...
    completions: Optional[Dict[str, Any]]
    """
...
class ToolListChangedNotification(BaseModel):
    ...
    params: Optional[Params28]


class Params29(BaseModel):
    uri: AnyUrl
    """
...
class Annotations(BaseModel):
    ...
    was attached, etc.
    """
    priority: Annotated[Optional[float], Field(ge=0.0, le=1.0)]
    """
...
class PingRequest(BaseModel):
    ...
    method: Literal["ping"]
    params: Optional[Params18]


class Params19(BaseModel):
...
class Tool(BaseModel):
    ...
    Intended for programmatic or logical use, but used as a display name in past specs or fallback (if title isn't present).
    """
    outputSchema: Optional[OutputSchema]
    """
    An optional JSON Schema object defining the structure of the tool's output returned in
    the structuredContent field of a CallToolResult.
    """
...
class RequestedSchema(BaseModel):
    ...
    properties: Dict[str, Union[StringSchema, NumberSchema, BooleanSchema, EnumSchema]]
    required: Optional[List[str]]
    type: Literal["object"]
...
class JSONRPCMessage(
    ...
    root: Union[JSONRPCRequest, JSONRPCNotification, JSONRPCResponse, JSONRPCError]
    """
...
class CallToolResult(BaseModel):
    ...
    should be reported as an MCP error response.
    """
    structuredContent: Optional[Dict[str, Any]]
    """
    An optional JSON object that represents the structured result of the tool call.
    """


class ClientResult(RootModel[Union[Result, CreateMessageResult, ListRootsResult, ElicitResult]]):
    root: Union[Result, CreateMessageResult, ListRootsResult, ElicitResult]


class Params3(BaseModel):
    includeContext: Optional[IncludeContext]
    """
    A request to include context from one or more MCP servers (including the caller), to be attached to the prompt. The client MAY ignore this request.
    """
    maxTokens: int
...
class ServerRequest(
    RootModel[Union[PingRequest, CreateMessageRequest, ListRootsRequest, ElicitRequest]]
):
    root: Union[PingRequest, CreateMessageRequest, ListRootsRequest, ElicitRequest]
