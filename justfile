...
rebuild service="api":  # Rebuild a specific service
...
config-load filename force="":  # Load configuration from YAML backup
    #!/usr/bin/env bash
    set -euo pipefail
...
config-save filename="":  # Save full configuration to YAML backup
    #!/usr/bin/env bash
    set -euo pipefail
